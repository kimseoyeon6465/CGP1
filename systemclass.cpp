...
SystemClass::SystemClass()
{
	m_Input = 0;
	m_Graphics = 0;
	isAmbientLighting = false;
	isDiffuseLighting = false;
	isSpecularLighting = false;
}
...
bool SystemClass::Frame()
{
	...
	//{
	//	if (isAmbientLighting == false)
	//	{
	//		m_Graphics->OnAmbient();
	//		isAmbientLighting = true;
	//	}
	//	else
	//	{
	...
	//{
	//	if (isDiffuseLighting == false)
	//	{
	//		m_Graphics->OnDiffuse();
	//		isDiffuseLighting = true;
	//	}
	//	else
	//	{
	...
	//{
	//	if (isSpecularLighting == false)
	//	{
	//		m_Graphics->OnSpecular();
	//		isSpecularLighting = true;
	//	}
	//	else
	//	{
